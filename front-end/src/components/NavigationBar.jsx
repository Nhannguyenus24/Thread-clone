...
const NavigationBar = () => {
  const [selectedSvg, setSelectedSvg] = useState("home");
  ...
  return (
    <div className="app-container">
        ...
        <ul>
          ...
          <div className="navigation-bar__menu">
            <li>
              <Link
                to="/"
                onClick={() => handleSvgClick("home")}
                className={`${
                  selectedSvg === "home" ? "navigation-bar__selected" : ""
                }`}
              >
            ...
            <li>
              <a
                onClick={() => handleSvgClick("find")}
                className={`${
                  selectedSvg === "find" ? "navigation-bar__selected" : ""
                }`}
              >
            ...
            <li>
              <Link
                to="notification"
                onClick={() => handleSvgClick("notification")}
                className={`${
                  selectedSvg === "notification"
            ...
            <li>
              <Link
                to="personal"
                onClick={() => handleSvgClick("personal")}
                className={`${
                  selectedSvg === "personal" ? "navigation-bar__selected" : ""
                }`}
              >
          ...
          <div className="navigation-bar__footer">
            ...
            <li>
              <a>
                <svg aria-label="Xem thêm" role="img" viewBox="0 0 24 24">
                  <rect
                    rx="1.25"
                    x="3"
                    y="7"
      ...
      <div className="main-content">
        <div className="infomation">Dành cho bạn</div>
